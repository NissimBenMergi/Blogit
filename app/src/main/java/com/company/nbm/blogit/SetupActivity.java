...
public class SetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupImage = findViewById(R.id.default_profile_image);
        setupName = findViewById(R.id.setup_name_text);
        setupSaveButton = findViewById(R.id.setup_save_button);
        loadingProgress = findViewById(R.id.setup_progress);
    ...
    private void StoreFirestore(@NonNull Task<UploadTask.TaskSnapshot> task, String user_name) {
        ...
        firebaseFirestore.collection("Users").document(user_id).set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(SetupActivity.this, "User settings is updated", Toast.LENGTH_SHORT).show();
